 ...
 * <br>
 * All children of this event are fired through {@link LostCityEvents}.
 **/
public class LostCityEvent {
    ...
    /**
     * Отмена события. Имеет смысл только для отменяемых событий
     * (PreGenCityChunkEvent, PreExplosionEvent).
     */
     ...
     * <br>
     * This event is fired through {@link LostCityEvents}.
     **/
